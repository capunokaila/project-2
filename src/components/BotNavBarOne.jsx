...
export default function BotNavBarOne() {
  ...
  return (
    <nav className="botnavbar">
        ...
        <NavLink to="/">
          <img src="images/home-filled.png" alt="Home Button" className="navbar__button-icon"></img>
        </NavLink>
        </div>
      ...
      <img src="images/heart.png" alt="Likes Button" className="navbar__button-icon"></img>
        ...
        <button className="navbar__button profile-button">
          ...
          <div className="profile-button__picture">
            ...
            <img src="images/default-user.png" alt="Default User" className="navbar__button-iconone"/>
